...
export const UserList = () => {
    ...
    useEffect(() => {
        dispatchEvent(new CustomEvent(UserListEvents.MOUNTED, {detail: component}));
        return () => {
            dispatchEvent(new CustomEvent(UserListEvents.UNMOUNTED));
        }
    }, [component]);

    const onNew = () => {
        dispatchEvent(new CustomEvent(UserListEvents.NEW, {detail: {}}));
        setSelectedUser(null);
    }
